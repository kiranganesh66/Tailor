  ...
  return (
    <div className="des-cont">
      ...
      <p className="desig-para">
        Unlike other interior design services, Boutique Interior Design focuses
        on creating an intimate and personalized customer shopping experience.
        Designers create cohesive and memorable shopping environments by
        considering brand identity, target market, and merchandise display. s
      </p>
